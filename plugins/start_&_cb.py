...
async def start(client, message: Message):
    ...
    buttons = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/YABOTZ'),
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/YABOTZ')
        ],
        [
    ...
    if data == "home":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ᴍʏ ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅs •", callback_data='help')],
                [InlineKeyboardButton('• ᴜᴘᴅᴀᴛᴇs', url='https://t.me/YABOTZ'), InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ •', url='https://t.me/YABOTZ')],
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• sᴜᴘᴘᴏʀᴛ", url='https://t.me/YABOTZ'), InlineKeyboardButton("ʙᴀᴄᴋ •", callback_data="help")]
            ])
        )
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton("ᴏᴡɴᴇʀ •", url='https://t.me/YABOTZ_BOT')]
            ])
        )
        ...
        await query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton("ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ •", url='https://t.me/YABOTZ_BOT')]
            ])
        )
    elif data == "plans":
        await query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• ᴄʟᴏsᴇ", callback_data="close"), InlineKeyboardButton("ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ •", url='https://t.me/YABOTZ_BOT')]
            ])
        )
    elif data == "about":
        await query.message.edit_text(
...
async def donation(client, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="help"), InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url='https://t.me/YABOTZ_BOT')]
    ])
